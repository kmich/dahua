...
#Checking lighting_v2 support
    ...
    def _process_plate_event(self, event: dict) -> None:
        """Process license plate data from event if present, updating sensors and firing events."""
    ...
    def on_receive_vto_event(self, event: dict):
        ...
        self._process_plate_event(event)
